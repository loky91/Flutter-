...
class StoryBrain{
  ...
  bool checkTheFirstTimeChoice1 = true;
  bool checkTheFirstTimeChoice2 = true;

  bool checkTheSecondTimeChoice1 = true;
  bool checkTheSecondTimeChoice2 = true;
  int _storyNumber=0;
...
List<Story> _storyData = [
  ...
  void nextStory(int choiceNumber) {
    if (choiceNumber == 1 && checkTheFirstTimeChoice1) {
      _storyNumber = 2;
      checkTheFirstTimeChoice1 = false;
    } else {
      if (choiceNumber == 1 &&
          checkTheSecondTimeChoice1 &&
          !checkTheFirstTimeChoice1) {
        _storyNumber = 5;
        checkTheSecondTimeChoice1 = false;
    ...
    if (choiceNumber == 2 && checkTheFirstTimeChoice2) {
      _storyNumber = 1;
      checkTheFirstTimeChoice2 = false;
    } else {
      if (choiceNumber == 1 &&
          checkTheSecondTimeChoice2 &&
          !checkTheFirstTimeChoice2) {
        _storyNumber = 2;
        checkTheSecondTimeChoice2 = false;
        checkTheFirstTimeChoice1 = false;
      } else if (choiceNumber == 2 &&
          checkTheSecondTimeChoice2 &&
          !checkTheFirstTimeChoice2) {
